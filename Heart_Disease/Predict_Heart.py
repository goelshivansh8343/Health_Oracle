...
Model_Path=os.path.join(BASE_DIR,"Trained_Model_SVC")
...
def predict_HeartDiseases(features):
    age,sex,cp,trestbps,chol,fbs,restecg,thalachh,exang,oldpeak,slope,ca,thal=features
    ans=Trained_Model.predict_proba(np.array(features).reshape(1,-1))
    print(ans)
